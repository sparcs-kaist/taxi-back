...
module.exports={
    agreeOnTermsOfServiceHandler : async (req, res) => {
        try {
    ...
    getAgreeOnTermsOfServiceHandler :  async (req, res) => {
        try {
    ...
    uploadProfileImageHandler : async (req, res) => {
        // 빈 파일이 아닌지 검사.
        if (!req.file) {
    ...
    idParticipateHandler :  async (req, res) => {
