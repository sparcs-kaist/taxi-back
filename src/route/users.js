...
// 이용 약관에 동의합니다.
router.post("/agreeOnTermsOfService", userHandlers.agreeOnTermsOfServiceHandler);
router.get("/getAgreeOnTermsOfService", userHandlers.getAgreeOnTermsOfServiceHandler);
...
router.post("/uploadProfileImage", uploadProfileImage, userHandlers.uploadProfileImageHandler);

// 아래 라우트 메서드들은 테스트 용도로만 사용 가능
/* GET users listing. */
router.get("/", userHandlers.userHandler);

router.get("/rooms", userHandlers.roomsHandler);
